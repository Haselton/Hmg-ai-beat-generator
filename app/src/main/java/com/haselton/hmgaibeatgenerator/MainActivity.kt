...
object BeatEngine{
 const val SR=44100
 fun style(p:String):Style{val s=p.lowercase();fun h(vararg a:String)=a.any{s.contains(it)};val voice=when{h("bell","chime")->"bell";h("organ")->"organ";h("string","orchestral")->"strings";h("synth","g-funk")->"synth";h("dark","horror")->"bell";else->"keys"};val bass=if(h("808","trap","drill"))"808" else if(h("funk","west coast"))"funk" else "sub";return Style(h("trap","drill"),h("boom bap","boombap","90s","grimy"),h("west coast","g-funk","funk"),h("dark","horror","ominous","sinister","creepy"),h("hard","aggressive","heavy","hardcore"),h("sparse","minimal","simple"),h("busy","complex","fast hats"),if(h("swing","boom bap","grimy")) .13 else 0.0,!h("happy","bright","major"),voice,bass)}
